...
output_dir = os.path.join(os.path.join("/scratch/m18/tg7098/Spherical_Benchmark_Kramer/Run_Convergence/"), 
...
if timing:
    uw.timing.stop()
    uw.timing.print_table(group_by='line_routine', output_file=f"{output_dir}/fn_evaluate_time.txt", display_fraction=1.00)
