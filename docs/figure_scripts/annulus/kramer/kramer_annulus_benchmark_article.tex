...
benchmark includes both free-slip and no-slip velocity
...
effectiveness of the Kramer et al. benchmark for assessing
...
\midrule
1 & Delta function & Free slip & \(n=2,8,32\) \\
2 & Smooth & Free slip & \(n=2,8,32;\ k=2,8\) \\
3 & Delta function & Zero slip & \(n=2,8,32\) \\
4 & Smooth & Zero slip & \(n=2,8,32;\ k=2,8\) \\
\bottomrule
\end{tabular}
\end{table}
...
We have presented a Copernicus-style summary of the \citetalias{Moresi2025} Kramer annulus Stokes
