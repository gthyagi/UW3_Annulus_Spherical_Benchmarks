...
\section{Boundary radial-stress convergence}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.68\linewidth]{sigma_rr_boundary_convergence.pdf}
    \caption{Convergence of the radial normal-stress error, \(\sigma_{rr}\), on the inner and outer spherical boundaries. Solid lines denote the inner boundary and dashed lines denote the outer boundary.}
    \label{fig:thieulot_sigma_rr_convergence}
\end{figure}

\begin{table}[H]
    \centering
    \includegraphics[width=0.98\linewidth]{table_sigma_rr_boundary_convergence.pdf}
    \caption{Boundary \(\sigma_{rr}\) \(L_2\)-norm errors and observed convergence rates for the inner and outer spherical surfaces.}
