...
\begin{minipage}[t]{0.475\textwidth}
  ...
  \includegraphics[
    ...
    keepaspectratio
  ]{../benchmarks_figures_and_articles/annulus/thieulot/figure_1_thieulot_annulus_analytical.pdf}
\end{minipage}
\ColumnGap
\begin{minipage}[t]{0.475\textwidth}
  \centering
  ...
  \includegraphics[
    ...
    height=\TopRowFigureHeight,
    keepaspectratio
  ]{../benchmarks_figures_and_articles/annulus/kramer/figure_1_kramer_annulus_rho_ana.pdf}
\end{minipage}
...
\begin{minipage}[t]{0.475\textwidth}
  ...
  \includegraphics[
    ...
    keepaspectratio
  ]{../benchmarks_figures_and_articles/spherical/thieulot/figure_2_thieulot_analytical.pdf}
\end{minipage}
\ColumnGap
\begin{minipage}[t]{0.475\textwidth}
  \centering
  ...
  \includegraphics[
    ...
    height=\BottomRowFigureHeight,
    keepaspectratio
  ]{../benchmarks_figures_and_articles/spherical/kramer/figure_2_kramer_rho_ana.pdf}
\end{minipage}
