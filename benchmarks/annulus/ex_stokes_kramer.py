...
from analytical_solutions.kramer_annulus import (
...
if use_constrained_stokes:
    stokes = uw.systems.Stokes_Constrained(mesh, velocityField=v_uw, pressureField=p_uw)
else:
...
#
# - free-slip cases constrain the normal velocity component by the selected
