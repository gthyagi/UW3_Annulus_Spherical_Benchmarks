#!/bin/bash
# Thieulot & Puckett (2018), Fig. 1-style annulus field cases:
# P2/P1 at fixed cellsize = 1/64, varying k = 0 and 2.

#PBS -P m18
#PBS -N th_p2p1_k0k2_cs64
#PBS -q normal
...
echo
echo "=== Thieulot annulus: P2/P1, cellsize=${cellsize}, k=0,2 ==="
...
echo
echo "Completed P2/P1 fixed-cellsize sweep for k = 0, 2."
